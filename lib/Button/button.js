...
var Props = function () {
  function Props(input) {
    return input != null && (input.component === undefined || typeof input.component === 'string') && (input.disabled === undefined || typeof input.disabled === 'boolean') && (input.type === undefined || input.type === 'primary' || input.type === 'gray' || input.type === 'link' || input.type === 'warning' || input.type === 'danger') && (input.active === undefined || typeof input.active === 'boolean') && typeof input.children === 'string' && input.styles instanceof Object;
  }
