...
var Props = function () {
  function Props(input) {
    return input != null && (input.component === undefined || typeof input.component === 'string') && (input.disabled === undefined || typeof input.disabled === 'boolean') && (input.type === undefined || input.type === 'primary' || input.type === 'secondary' || input.type === 'alternate' || input.type === 'warning' || input.type === 'danger') && (input.active === undefined || typeof input.active === 'boolean') && typeof input.children === 'string';
  }
...
function Button(_ref) {
  ...
  var Component = _ref$component === undefined ? 'button' : _ref$component;
  ...
  return _react2.default.createElement(
    Component,
    (0, _extends3.default)({}, other, { tabIndex: '0', disabled: Component === 'button' && disabled, styleName: styleName }),
    children
  );
}
Button.defaultProps = {
