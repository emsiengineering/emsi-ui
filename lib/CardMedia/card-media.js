...
var _cardMedia = require('./card-media.css');
...
var Props = function () {
  function Props(input) {
    return input != null && (input.component === undefined || typeof input.component === 'string');
  }
...
function CardMedia(_ref) {
  ...
  return _react2.default.createElement(
    Component,
    (0, _extends3.default)({ styleName: 'card-media' }, other),
    children
  );
}

exports.default = (0, _reactCssModules2.default)(CardMedia, _cardMedia2.default);
