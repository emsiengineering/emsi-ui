...
function Col(_ref) {
  var children = _ref.children,
      ...
      styles = _ref.styles,
      other = (0, _objectWithoutProperties3.default)(_ref, ['children', 'component', 'styles']);
  ...
  var xs = other.xs,
      ...
      md = other.md,
      lg = other.lg,
      xsOffset = other.xsOffset,
      smOffset = other.smOffset,
      mdOffset = other.mdOffset,
      lgOffset = other.lgOffset,
      rest = (0, _objectWithoutProperties3.default)(other, ['xs', 'sm', 'md', 'lg', 'xsOffset', 'smOffset', 'mdOffset', 'lgOffset']);
