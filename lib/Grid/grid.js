...
var Props = function () {
  function Props(input) {
    return input != null && (input.fluid === undefined || typeof input.fluid === 'boolean') && (input.component === undefined || typeof input.component === 'string') && input.styles instanceof Object && (input.other === undefined || input.other instanceof Object);
  }
...
function Grid(_ref) {
  ...
  var styleName = fluid ? 'fluid' : 'grid';
