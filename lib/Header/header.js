...
function Header(_ref) {
  ...
  var other = (0, _objectWithoutProperties3.default)(_ref, ['component', 'tabIndex', 'color', 'children', 'type', 'bold', 'styles']);
  ...
  return _react2.default.createElement(
    Component,
    (0, _extends3.default)({ tabIndex: tabIndex }, other, { styleName: styleNames += ' ' + color }),
    children
  );
}
Header.defaultProps = {
