...
function Header(_ref) {
  ...
  var styleNames = bold ? 'bold ' + type : '' + type;
  ...
  return _react2.default.createElement(
    Component,
    (0, _extends3.default)({}, other, { styleName: styleNames }),
    children
  );
}
