...
var Props = function () {
  function Props(input) {
    return input != null && (input.component === undefined || typeof input.component === 'string') && (input.name === 'radioChecked' || input.name === 'radio' || input.name === 'checkboxChecked' || input.name === 'checkbox' || input.name === 'dropdown' || input.name === 'close' || input.name === 'search') && (input.size === undefined || input.size === 'small' || input.size === 'medium' || input.size === 'large' || input.size == null) && (input.color === undefined || input.color === 'primary' || input.color === 'link' || input.color == null) && input.styles instanceof Object && (input.other === undefined || input.other instanceof Object);
  }
