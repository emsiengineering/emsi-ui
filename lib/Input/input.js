...
function Input(_ref) {
  ...
  var other = (0, _objectWithoutProperties3.default)(_ref, ['component', 'onChange', 'ariaLabel', 'handleRef', 'id', 'disabled', 'required', 'error', 'errorMessage', 'placeholder', 'children', 'ref', 'styles']);
