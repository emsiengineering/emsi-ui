...
function Input(_ref) {
  ...
  var Component = _ref$component === undefined ? 'input' : _ref$component;
  var _ref$onChange = _ref.onChange;
  var onChange = _ref$onChange === undefined ? function noop() {} : _ref$onChange;
  ...
  var CSS = _ref.styles;
  var other = (0, _objectWithoutProperties3.default)(_ref, ['children', 'component', 'onChange', 'placeholder', 'errorMessage', 'required', 'error', 'disabled', 'styles']);
  ...
  return _react2.default.createElement(
    'label',
    { styleName: 'label' },
    _react2.default.createElement(Component, (0, _extends3.default)({}, other, {
      onChange: onChange,
      disabled: disabled,
      styleName: styleName,
