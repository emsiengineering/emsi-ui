...
var Input = function (_React$Component) {
  ...
  (0, _createClass3.default)(Input, [{
    ...
    value: function render() {
      ...
      var ref = _props.ref;
      var css = _props.css;
      var other = (0, _objectWithoutProperties3.default)(_props, ['component', 'onChange', 'id', 'handleRef', 'disabled', 'required', 'error', 'errorMessage', 'placeholder', 'children', 'ref', 'css']);
