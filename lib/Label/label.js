...
var Props = function () {
  function Props(input) {
    return input != null && (input.component === undefined || typeof input.component === 'string') && (input.color === undefined || input.color === 'primary' || input.color === 'link') && input.styles instanceof Object && (input.other === undefined || input.other instanceof Object);
  }
