...
var Props = function () {
  function Props(input) {
    return input != null && (input.active === undefined || typeof input.active === 'boolean') && input.styles instanceof Object && typeof input.tabIndex === 'number' && typeof input.title === 'string' && typeof input.top === 'boolean';
  }
