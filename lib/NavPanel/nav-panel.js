...
var NavPanel = function (_React$Component) {
  ...
  function NavPanel(props) {
    ...
    var active = (0, _utils.getChildIndexByProp)(props.children);
  ...
  (0, _createClass3.default)(NavPanel, [{
    ...
    value: function renderSpan() {
      ...
      if (active < 0 && !hovering) offset = -300;else for (var i = this.state[by] - 1; i >= 0; i--) {
        offset += widths[i];
      }
    ...
    value: function render() {
      ...
      var other = (0, _objectWithoutProperties3.default)(_props, ['children', 'top', 'className']);
      ...
      var menu = this.props.children.map(function (child, index) {
        ...
        var clone = _react2.default.cloneElement(child, {
          onClick: function onClick() {
            return _this2.handleClick(index, child.props.to);
          },
