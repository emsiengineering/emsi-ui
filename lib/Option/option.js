...
var _option = require('./option.css');
...
var Props = function () {
  function Props(input) {
    return input != null && (input.active === undefined || typeof input.active === 'boolean') && (input.onClick === undefined || typeof input.onClick === 'function');
  }
...
function Option(_ref) {
  ...
  var styleName = active ? 'active' : 'option';
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      { styleName: styleName, tabIndex: '0' },
      children
    )
  );
}
