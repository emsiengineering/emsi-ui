...
var Props = function () {
  function Props(input) {
    ...
    }) && (input.onSelect === undefined || typeof input.onSelect === 'function') && (input.disabled === undefined || typeof input.disabled === 'boolean') && (input.styles === undefined || input.styles instanceof Object) && (input.other === undefined || input.other instanceof Object);
  }
