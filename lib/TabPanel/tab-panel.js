...
var Props = function () {
  function Props(input) {
    return input != null && (input.position === 'top' || input.position === 'bottom') && (input.theme === 'dark' || input.theme == null) && (input.onClick === undefined || typeof input.onClick === 'function') && (input.activeTab === undefined || typeof input.activeTab === 'number' || typeof input.activeTab === 'string') && (input.center === undefined || typeof input.center === 'boolean') && (input.padded === undefined || typeof input.padded === 'boolean');
  }
...
var TabPanel = function (_React$Component) {
  ...
  (0, _createClass3.default)(TabPanel, [{
    ...
    value: function render() {
      ...
      var other = (0, _objectWithoutProperties3.default)(_props, ['position', 'onClick', 'activeTab', 'theme', 'center', 'padded']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { onClick: onClick, activeTabId: this.state.childIds[this.props.activeTab] || this.props.activeTab },
          _react2.default.createElement(
...
TabPanel.propTypes = {
  position: function position(props, name, component) {
    var prop = props[name];
  ...
  theme: function theme(props, name, component) {
    var prop = props[name];

    if (!(prop === 'dark' || prop == null)) {
      return new Error("Invalid prop `" + name + "` supplied to `" + component + "`.\n\nExpected:\n" + '\'dark\' | void' + "\n\nGot:\n" + _inspect(prop) + "\n\n");
    }
  },
  ...
  activeTab: function activeTab(props, name, component) {
    var prop = props[name];
  ...
  center: function center(props, name, component) {
    var prop = props[name];
  ...
  padded: function padded(props, name, component) {
    var prop = props[name];
